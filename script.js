...
const zhTranslations = {
  ...
  "Use this section for Canva designs, visual references, product presentation examples, space planning images, showroom photos, or customer consultation materials.": "这里可放置 Canva 设计、视觉参考、产品展示案例、空间规划图片、展厅照片或客户咨询素材。",
  "Photo 01": "照片 01",
  "Photo 02": "照片 02",
  "Photo 03": "照片 03",
  ...
  "Add older retail product photos, demo setup images, or relevant presentation materials here.": "这里可添加过往零售产品照片、演示布置图片或相关展示素材。",
  ...
  "Add older workflow screenshots, planning boards, CRM examples, or automation diagrams here.": "这里可添加过往工作流截图、规划看板、CRM 示例或自动化图表。",
